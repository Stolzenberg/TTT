...
/// <param name="Flags">
///     Extra data that we can pass around. Like if it's a blind-shot, mid-air shot, through smoke shot,
///     etc.
/// </param>
...
/// <summary>
///     Event dispatched on the server when something takes damage, so it can be modified.
/// </summary>
public abstract class ModifyDamageEvent : IGameEvent
{
    ...
    /// <summary>
    ///     Scales <see cref="DamageInfo.Damage" /> by <paramref name="damageScale" />, adding the difference to
    ///     <see cref="DamageInfo.ArmorDamage" />.
    /// </summary>
...
/// <summary>
///     Event dispatched on server when this object is about to take damage, so it can be modified.
/// </summary>
...
/// <summary>
///     Event dispatched on the server when this object is about to deal damage, so it can be modified.
/// </summary>
...
/// <summary>
///     Event dispatched on the server when any object is about to deal damage, so it can be modified.
/// </summary>
