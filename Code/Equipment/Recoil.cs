...
public class Recoil : EquipmentComponent
{
    [Property]
    public float ResetTime { get; set; } = 0.3f;

    // Recoil Patterns
    [Property, FeatureEnabled("Recoil Pattern")]
    public bool UseRecoilPattern { get; set; } = false;

    [Property, Category("UseRecoilPattern"), Feature("Recoil Pattern")]
    public Vector2 Scale { get; set; } = new(2f, 5f);

    [Property, Category("UseRecoilPattern"), Feature("Recoil Pattern")]
    public RecoilPattern RecoilPattern { get; set; } = new();

    [Property, Group("Standard Recoil"), Feature("Standard Recoil")]
